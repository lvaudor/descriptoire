...
On utilise le package `widyr` [@widyr] pour calculer les effectifs croisés:
...
Le package `textometry` [@txm] comprend une fonction qui permet de calculer des scores de spécificité [@specificite]. Le but de ce score est (comme pour le TF-IDF) d'**identifier les termes spécifiques à une partie du corpus**.
